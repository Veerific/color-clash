...
```
cd existing_repo
git remote add origin https://gitlab.fdmci.hva.nl/majarov/colorclash.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.fdmci.hva.nl/majarov/colorclash/-/settings/integrations)
